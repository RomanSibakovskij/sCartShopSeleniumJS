...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //invalid guest product(s) checkout confirmation test method - too short address phone (7 digits)
    async invalidProductCheckoutConfirmTooShortAddressPhoneTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        //input valid guest email into email input field
        await checkoutPageValidGuestInput.inputValidGuestEmailIntoEmailInputField();
        //input too short guest phone into phone input field (7 digits)
        await checkoutPageInvalidSingularInput.inputTooShortGuestPhoneIntoPhoneInputField();
        //click country dropdown menu
        await checkoutPage.clickCountryDropdownMenu();
        //select "United States" option
        await checkoutPage.selectUnitedStatesOption();
        ...
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - too short address phone
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Too Short Address Phone");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const tooShortCheckoutGuestAddressPhoneInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(tooShortCheckoutGuestAddressPhoneInputError, "The phone format is not correct. Length 8-14, use only 0-9 and the \"-\" SIGN.", "The too short checkout guest address phone input error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Short Address Phone");
            throw new Error("The too short checkout guest address phone input error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Short Address Phone");
    }

    //invalid guest product(s) checkout confirmation test method - too short address one (3 chars)
    async invalidProductCheckoutConfirmTooShortAddressOneTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        //select "United States" option
        await checkoutPage.selectUnitedStatesOption();
        //input too short guest address one into address one input field (3 chars)
        await checkoutPageInvalidSingularInput.inputTooShortGuestAddressOneIntoAddressOneInputField();
        //input valid guest address two into address two input field
        await checkoutPageValidGuestInput.inputValidGuestAddressTwoIntoAddressTwoInputField();
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - too short address one
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Too Short Address One");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const tooShortCheckoutGuestAddressOneInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(tooShortCheckoutGuestAddressOneInputError, "The address one is too short.", "The too short checkout guest address one input error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Short Address One");
            throw new Error("The too short checkout guest address one input error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Short Address One");
    }

    //invalid guest product(s) checkout confirmation test method - too short address two (3 chars)
    async invalidProductCheckoutConfirmTooShortAddressTwoTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        //input valid guest address one into address one input field
        await checkoutPageValidGuestInput.inputValidGuestAddressOneIntoAddressOneInputField();
        //input too short guest address two into address two input field (3 chars)
        await checkoutPageInvalidSingularInput.inputTooShortGuestAddressTwoIntoAddressTwoInputField();
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - too short address two
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Too Short Address Two");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const tooShortCheckoutGuestAddressTwoInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(tooShortCheckoutGuestAddressTwoInputError, "The address two is too short.", "The too short checkout guest address two input error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Short Address Two");
            throw new Error("The too short checkout guest address two input error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Short Address Two");
    }
    ...
    //invalid guest product(s) checkout confirmation test method - too long address first name (100 chars)
    async invalidProductCheckoutConfirmTooLongAddressFirstNameTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        await checkoutPageInvalidSingularInput.inputTooLongGuestFirstNameIntoFirstNameInputField();
        //input valid guest last name into last name input field
        await checkoutPageValidGuestInput.inputValidGuestLastNameIntoLastNameInputField();
        //input valid guest email into email input field
        await checkoutPageValidGuestInput.inputValidGuestEmailIntoEmailInputField();
        ...
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - too long address first name
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Too Long Address First Name");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const tooLongCheckoutGuestAddressFirstNameInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(tooLongCheckoutGuestAddressFirstNameInputError, "The first name is too long.", "The too long checkout guest address first name input error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Long Address First Name");
            throw new Error("The too long checkout guest address first name input error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Long Address First Name");
    }

    //invalid guest product(s) checkout confirmation test method - too long address last name (100 chars)
    async invalidProductCheckoutConfirmTooLongAddressLastNameTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        await checkoutPageInvalidSingularInput.inputTooLongGuestLastNameIntoLastNameInputField();
        //input valid guest email into email input field
        await checkoutPageValidGuestInput.inputValidGuestEmailIntoEmailInputField();
        //input valid guest phone into phone input field
        await checkoutPageValidGuestInput.inputValidGuestPhoneIntoPhoneInputField();
        ...
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - too long address last name
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Too Long Address Last Name");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const tooLongCheckoutGuestAddressLastNameInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(tooLongCheckoutGuestAddressLastNameInputError, "The last name is too long.", "The too long checkout guest address last name input error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Long Address Last Name");
            throw new Error("The too long checkout guest address last name input error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Long Address Last Name");
    }

    //invalid guest product(s) checkout confirmation test method - too long address email (100 chars -> name, domain)
    async invalidProductCheckoutConfirmTooLongAddressEmailTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        await checkoutPageInvalidSingularInput.inputTooLongGuestEmailIntoEmailInputField();
        //input valid guest phone into phone input field
        await checkoutPageValidGuestInput.inputValidGuestPhoneIntoPhoneInputField();
        //click country dropdown menu
        await checkoutPage.clickCountryDropdownMenu();
        ...
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - too long address email
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Too Long Address Email");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const tooLongCheckoutGuestAddressEmailInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(tooLongCheckoutGuestAddressEmailInputError, "The Email field must be a valid email address.", "The too long checkout guest address email input error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Long Address Email");
            throw new Error("The too long checkout guest address email input error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Long Address Email");
    }

    //invalid guest product(s) checkout confirmation test method - too long address phone (15 digits)
    async invalidProductCheckoutConfirmTooLongAddressPhoneTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        //input valid guest email into email input field
        await checkoutPageValidGuestInput.inputValidGuestEmailIntoEmailInputField();
        //input too long guest phone into phone input field (7 digits)
        await checkoutPageInvalidSingularInput.inputTooLongGuestPhoneIntoPhoneInputField();
        //click country dropdown menu
        await checkoutPage.clickCountryDropdownMenu();
        //select "United States" option
        await checkoutPage.selectUnitedStatesOption();
        ...
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - too long address phone
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Too Long Address Phone");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const tooLongCheckoutGuestAddressPhoneInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(tooLongCheckoutGuestAddressPhoneInputError, "The phone format is not correct. Length 8-14, use only 0-9 and the \"-\" SIGN.", "The too long checkout guest address phone input error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Long Address Phone");
            throw new Error("The too long checkout guest address phone input error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Long Address Phone");
    }

    //invalid guest product(s) checkout confirmation test method - too long address one (101 chars)
    async invalidProductCheckoutConfirmTooLongAddressOneTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        //select "United States" option
        await checkoutPage.selectUnitedStatesOption();
        //input too long guest address one into address one input field (101 chars)
        await checkoutPageInvalidSingularInput.inputTooLongGuestAddressOneIntoAddressOneInputField();
        //input valid guest address two into address two input field
        await checkoutPageValidGuestInput.inputValidGuestAddressTwoIntoAddressTwoInputField();
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - too long address one
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Too Long Address One");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const tooLongCheckoutGuestAddressOneInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(tooLongCheckoutGuestAddressOneInputError, "The Address 1 field must not be greater than 100 characters.", "The too long checkout guest address one input error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Long Address One");
            throw new Error("The too long checkout guest address one input error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Long Address One");
    }

    //invalid guest product(s) checkout confirmation test method - too long address two (101 chars)
    async invalidProductCheckoutConfirmTooLongAddressTwoTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        //input valid guest address one into address one input field
        await checkoutPageValidGuestInput.inputValidGuestAddressOneIntoAddressOneInputField();
        //input too long guest address two into address two input field (3 chars)
        await checkoutPageInvalidSingularInput.inputTooLongGuestAddressTwoIntoAddressTwoInputField();
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - too long address two
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Too Long Address Two");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const tooLongCheckoutGuestAddressTwoInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(tooLongCheckoutGuestAddressTwoInputError, "The Address 2 field must not be greater than 100 characters.", "The too long checkout guest address two input error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Long Address Two");
            throw new Error("The too long checkout guest address two input error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Too Long Address Two");
    }
    ...
    //invalid guest product(s) checkout confirmation test method - invalid address first name format (special symbols only)
    async invalidProductCheckoutConfirmInvalidAddressFirstNameFormatTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        await checkoutPageInvalidSingularInput.inputInvalidGuestFirstNameFormatIntoFirstNameInputField();
        //input valid guest last name into last name input field
        await checkoutPageValidGuestInput.inputValidGuestLastNameIntoLastNameInputField();
        //input valid guest email into email input field
        await checkoutPageValidGuestInput.inputValidGuestEmailIntoEmailInputField();
        ...
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - invalid address first name input format
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Invalid Address First Name Format");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const invalidCheckoutGuestAddressFirstNameFormatInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(invalidCheckoutGuestAddressFirstNameFormatInputError, "The first name cannot consist of special symbols only.", "The invalid checkout guest address first name input format error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Invalid Address First Name Format");
            throw new Error("The invalid checkout guest address first name input format error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Invalid Address First Name Format");
    }

    //invalid guest product(s) checkout confirmation test method - invalid address last name format (special symbols only)
    async invalidProductCheckoutConfirmInvalidAddressLastNameFormatTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        await checkoutPageInvalidSingularInput.inputInvalidGuestLastNameFormatIntoLastNameInputField();
        //input valid guest email into email input field
        await checkoutPageValidGuestInput.inputValidGuestEmailIntoEmailInputField();
        //input valid guest phone into phone input field
        await checkoutPageValidGuestInput.inputValidGuestPhoneIntoPhoneInputField();
        ...
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - invalid address last name input format
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Invalid Address Last Name Format");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const invalidCheckoutGuestAddressLastNameFormatInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(invalidCheckoutGuestAddressLastNameFormatInputError, "The last name cannot consist of special symbols only.", "The invalid checkout guest address last name input format error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Invalid Address Last Name Format");
            throw new Error("The invalid checkout guest address last name input format error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Invalid Address Last Name Format");
    }

    //invalid guest product(s) checkout confirmation test method - invalid address email format (missing '@')
    async invalidProductCheckoutConfirmInvalidAddressEmailFormatTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        await checkoutPageInvalidSingularInput.inputInvalidGuestEmailFormatIntoEmailInputField();
        //input valid guest phone into phone input field
        await checkoutPageValidGuestInput.inputValidGuestPhoneIntoPhoneInputField();
        //click country dropdown menu
        await checkoutPage.clickCountryDropdownMenu();
        ...
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - invalid address email input format
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Invalid Address Email Format");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const invalidCheckoutGuestAddressEmailInputFormatError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(invalidCheckoutGuestAddressEmailInputFormatError, "The Email field must be a valid email address.", "The invalid checkout guest address email input format error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Invalid Address Email Format");
            throw new Error("The invalid checkout guest address email input format error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Invalid Address Email Format");
    }

    //invalid guest product(s) checkout confirmation test method - existing address email format (used beforehand in manual testing)
    async invalidProductCheckoutConfirmExistingAddressEmailFormatTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        //input valid guest last name into last name input field
        await checkoutPageValidGuestInput.inputValidGuestLastNameIntoLastNameInputField();
        //input existing guest email format into email input field (used beforehand in manual testing)
        await checkoutPageInvalidSingularInput.inputExistingGuestEmailIntoEmailInputField();
        //input valid guest phone into phone input field
        await checkoutPageValidGuestInput.inputValidGuestPhoneIntoPhoneInputField();
        //click country dropdown menu
        await checkoutPage.clickCountryDropdownMenu();
        ...
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - existing address email
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Existing Address Email");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const existingCheckoutGuestAddressEmailInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(existingCheckoutGuestAddressEmailInputError, "The Email field must be a valid email address.", "The existing checkout guest address email input error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Existing Address Email");
            throw new Error("The existing checkout guest address email input error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Existing Address Email");
    }

    //invalid guest product(s) checkout confirmation test method - invalid address phone format (special symbols only)
    async invalidProductCheckoutConfirmInvalidAddressPhoneFormatTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        await checkoutPageInvalidSingularInput.inputInvalidGuestPhoneFormatIntoPhoneInputField();
        //click country dropdown menu
        await checkoutPage.clickCountryDropdownMenu();
        //select "United States" option
        await checkoutPage.selectUnitedStatesOption();
        ...
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - invalid address phone input format
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Invalid Address Phone Format");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const invalidCheckoutGuestAddressPhoneFormatInputError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(invalidCheckoutGuestAddressPhoneFormatInputError, "The phone format is not correct. Length 8-14, use only 0-9 and the \"-\" SIGN.", "The invalid checkout guest address phone input format error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Invalid Address Phone Format");
            throw new Error("The invalid checkout guest address phone input format error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Invalid Address Phone Format");
    }

    //invalid guest product(s) checkout confirmation test method - invalid address one format (special symbols only)
    async invalidProductCheckoutConfirmInvalidAddressOneFormatTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        //select "United States" option
        await checkoutPage.selectUnitedStatesOption();
        //input invalid guest address one format into address one input field (special symbols only)
        await checkoutPageInvalidSingularInput.inputInvalidGuestAddressOneFormatIntoAddressOneInputField();
        //input valid guest address two into address two input field
        await checkoutPageValidGuestInput.inputValidGuestAddressTwoIntoAddressTwoInputField();
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - invalid address one input format
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Invalid Address One Format");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const invalidCheckoutGuestAddressOneInputFormatError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(invalidCheckoutGuestAddressOneInputFormatError, "The address one cannot consist of special symbols only.", "The invalid checkout guest address one input format error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Invalid Address One Format");
            throw new Error("The invalid checkout guest address one input format error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Invalid Address One Format");
    }

    //invalid guest product(s) checkout confirmation test method - invalid address two format (101 chars)
    async invalidProductCheckoutConfirmInvalidAddressTwoFormatTest(){
        const basePage = new BasePage(this.driver);
        const generalPage = new GeneralPage(this.driver);
        const generalPageTextElementAsserts = new GeneralPageTextElementAsserts(this.driver);
        const checkoutPage = new CheckoutPage(this.driver);
        ...
        //input valid guest address one into address one input field
        await checkoutPageValidGuestInput.inputValidGuestAddressOneIntoAddressOneInputField();
        //input invalid guest address two format into address two input field (special symbols only)
        await checkoutPageInvalidSingularInput.inputInvalidGuestAddressTwoFormatIntoAddressTwoInputField();
        //input valid guest note into note text area
        await checkoutPageValidGuestInput.inputValidGuestNoteIntoNoteTextarea();
        //capture screenshot of the checkout page display after invalid data input (guest) - invalid address two input format
        await captureScreenshot(this.driver, "Checkout Page Input Address Section Display After Invalid Data Input (guest) - Invalid Address Two Format");
        //click "Checkout" button
        await checkoutPage.clickCheckoutButton();
        //wait for elements to load (due to network issues, wait time is extended)
        await basePage.waitForElementLoad(2500);
        //assert the user receives an expected error message, throw an error otherwise
        try {
            const invalidCheckoutGuestAddressTwoInputFormatError = await checkoutPage.getCheckoutPageAddressSingularInputErrorMessage();
            assert.strictEqual(invalidCheckoutGuestAddressTwoInputFormatError, "The address 2 cannot consist of special symbols only.", "The invalid checkout guest address two input format error doesn't match expectations.");
        } catch {
            await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Invalid Address Two Format");
            throw new Error("The invalid checkout guest address two input format error wasn't triggered, test has failed");
        }
        //capture screenshot of the test result
        await captureScreenshot(this.driver, "Invalid Product(s) Checkout Confirmation Test Result (guest) - Invalid Address Two Format");
    }
