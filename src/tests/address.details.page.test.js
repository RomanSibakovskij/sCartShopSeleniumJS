...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    describe("Invalid Edit User Address Details Tests - Invalid Singular Input Format", () => {
        ...
        //Test 005s -> invalid edit user address details test - invalid edited address one format (special symbols only) (the error wasn't triggered, test has failed)
        test("Invalid Edit User Address Details Test - Invalid Edited Address One Format", async function () {
            //navigate user to register page test
            await testMethods.navigateToRegisterPageTest();
            //valid user account creation test
            await testMethods.validUserAccountCreationTest();
            //invalid edit user address details test - invalid edited address one format
            await testMethods.invalidEditUserAddressInvalidAddressOneFormatTest();
        });

        //Test 005t -> invalid edit user address details test - invalid edited address two format (special symbols only) (the error wasn't triggered, test has failed)
        test("Invalid Edit User Address Details Test - Invalid Edited Address Two Format", async function () {
            //navigate user to register page test
            await testMethods.navigateToRegisterPageTest();
            //valid user account creation test
            await testMethods.validUserAccountCreationTest();
            //invalid edit user address details test - invalid edited address two format
            await testMethods.invalidEditUserAddressInvalidAddressTwoFormatTest();
        });

    });

    describe("Remove User Address Test", () => {

        //Test 006 -> remove user address test
        test("Remove User Address Test", async function () {
            //navigate user to register page test
            await testMethods.navigateToRegisterPageTest();
            //valid user account creation test
            await testMethods.validUserAccountCreationTest();
