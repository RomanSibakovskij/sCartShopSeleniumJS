...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    describe("Multiple Searched Products Checkout Confirmation Tests", () => {
        ...
        //Test 021c -> multiple searched products ("Sample product 10 - English") check out confirmation test (as a registered user)
        test("Multiple Searched Products Checkout Confirmation Test (as a registered user)", async function () {
            //navigate user to register page test
            await testMethods.navigateToRegisterPageTest();
            //valid user account creation test
            await testMethods.validUserAccountCreationTest();
            ...
            await testMethods.addProductToCheckoutRegUserTest();
            //multiple searched products ("Sample product 10 - English") check out confirmation test (as a registered user)
            await testMethods.validProductCheckoutConfirmationRegUserTest();
        });

    });

    describe("Single Category Single Product Checkout Confirmation Tests", () => {

        //Test 022 -> single category single product ("Product bundle 2 - English") check out confirmation test (as a guest)
        test("Single Category Single Product Checkout Confirmation Test (as a guest)", async function () {
            ...
            await testMethods.addProductToCheckoutGuestTest();
            //single category single product ("Product bundle 2 - English") check out confirmation test (as a guest)
            await testMethods.validProductCheckoutConfirmationTest();
        });

        //Test 022a -> single category single product ("Sample product 4 - English") check out confirmation test (as a registered user)
        test("Single Category Single Product Checkout Confirmation Test (as a registered user)", async function () {
            //navigate user to register page test
            await testMethods.navigateToRegisterPageTest();
            //valid user account creation test
            await testMethods.validUserAccountCreationTest();
