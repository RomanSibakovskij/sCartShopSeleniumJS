...
class RegisterPageInvalidSingularInput extends BasePage{
    ...
    async inputInvalidFirstNameFormatIntoFirstNameInputField(){
        ...
        Logger.info("Invalid register user first name format: ", invalidFirstNameFormat);
    ...
    async inputExistingEmailIntoEmailInputField(){
        ...
        Logger.info("Existing register user email: ", existingEmail);
    ...
    async inputInvalidAddressTwoFormatIntoAddressTwoInputField(){
        const addressTwoInputField = await this.driver.findElement(this._registerPageAddressTwoInputField);
