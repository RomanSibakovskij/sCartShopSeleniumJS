...
class GeneralPage extends BasePage{
    ...
    //input set product ("Sample product 14 - English") search query into search input field method
    async inputProductFourteenSearchQueryIntoSearchInputField(){
        const searchInputField = await this.driver.findElement(this._headerSearchInputField);
        const searchQuery = "Sample product 14 - English";
        Logger.info("Valid product search query: ", searchQuery);
